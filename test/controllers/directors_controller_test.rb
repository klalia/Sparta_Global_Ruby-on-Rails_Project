...
class DirectorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create director" do
    assert_difference('Director.count') do
      post directors_url, params: { director: { name: @director.name, user_id=integer: @director.user_id=integer } }
    end
  ...
  test "should update director" do
    patch director_url(@director), params: { director: { name: @director.name, user_id=integer: @director.user_id=integer } }
